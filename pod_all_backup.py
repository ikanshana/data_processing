...
start = timer.time()
print("\n Saving POD modes ...")
fn = data_dir + 'combined_pod_modes.nc'
#'/home/administrateur/Documents/lmfl_data/G_H_2.4_100Hz/POD1/combined_' + 'pod_modes.nc'
...
for dim in ds_w.dimensions.items():
    print("Dimensions for writable POD modes", dim)
...
eig_vec = ds_w.createVariable('eig_vec',np.float64,('dim_t','dim_t')) 
eig_val = ds_w.createVariable('eig_val',np.float64,('dim_t',)) 
